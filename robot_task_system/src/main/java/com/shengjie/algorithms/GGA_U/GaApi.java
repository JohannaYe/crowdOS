...
public class GaApi {
    ...
    private double distanceThreshold = 10000; //代价阈值
    ...
    public GaApi(int workerNum,int taskNum, double[][] distanceMatrix, double[][] taskDistanceMatrix, int[] p , int q,
...
//            System.out.println("变异结束");
    ...
    public void initPopulation(List<Individual> population) {
        for (int i = 0; i < populationNum; i++) {
            population.add(new Individual(workerNum,taskNum,distanceMatrix,taskDistanceMatrix,p,q,workerLocationList,taskLocationList));
        }
    }
...
//            System.out.println(individualJ.getAssignMap().toString());
    ...
    public double calculatePWT(int workerNum,int taskNum){
        double p = 1;
        return p;
    }
